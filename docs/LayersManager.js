...
L.Control.layersManager = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    let listElement2 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement3 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement4 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement5 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement6 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement7 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement8 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement9 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement10 = this.listElement = L.DomUtil.create('li', '', list);
    ...
    let listElement11 = this.listElement = L.DomUtil.create('li', '', list);
